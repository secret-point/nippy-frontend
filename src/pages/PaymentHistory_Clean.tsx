...
import { Payment, PaymentStats } from '../services/paymentAPI'
...
export const PaymentHistory: React.FC = () => {
  ...
  const convertPaymentToRecord = (payment: Payment): PaymentRecord => ({
    id: payment.id,
    freelancer: {
      name: payment.freelancerName || 'Unknown',
      role: payment.projectTitle || 'No Project',
      avatar: payment.freelancerAvatar
    },
