        ...
        <div className="max-w-md mx-auto w-full">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              Nice to meet you. You don't have to work for me again.
              Because I cheated many developers without paying them.
              For example, I hired a developer to build a backend test for me and after he finished the work, I refused to pay him.
              With deleting all connections with him.
            </h1>
